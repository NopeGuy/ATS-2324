...
public class EncomendaTest {
    ...
    public void testConstrutorPadrao() {
        ...
        assertEquals(0.0, encomenda.getPrecoFinal());
        assertEquals(0.0, encomenda.getCustosExpedicao());
    ...
    public void testConstrutorComParametros() {
        ...
        assertEquals(2, encomenda.getId()); // Supondo que é a segunda encomenda a ser criada
        assertEquals("Dono1", encomenda.getDono());
        assertEquals(artigos, encomenda.getArtigos());
        assertEquals(0.0, encomenda.getPrecoFinal());
        assertEquals(15.0, encomenda.getCustosExpedicao());
    ...
    public void testSetters() {
        ...
        assertEquals(200.0, encomenda.getPrecoFinal());
    ...
    public void testToString() {
        ...
        LocalDate dataCriacao = LocalDate.of(2023, 5, 1);
        Encomenda encomenda = new Encomenda("Dono1", artigos, 15.0, dataCriacao, vendedores);
        String esperado = "==========  Encomenda  ==========\\n" +
                "ID da Encomenda: " + encomenda.getId() + "\\n" +
                "Encomenda criada em: " + dataCriacao + "\\n" +
                "Prazo Limite: " + dataCriacao.plusDays(2) + "\\n" +
                "==========   Artigos   ==========\\n" +
                "========== Fim Artigos ==========\\n" +
                "Dimensão da embalagem: null\\n" +
                "Custo Expedição: 15.0\\n" +
                "Preço final: 0.0\\n" +
                "Estado da encomenda: EXPEDIDA\\n";

        assertEquals(esperado, encomenda.toString());
    }
