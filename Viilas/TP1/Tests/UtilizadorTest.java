...
public class UtilizadorTest {
    ...
    public void testConstrutorPadrao() {
        ...
        assertEquals(1, utilizador.getId());
        ...
        assertTrue(utilizador.getVendas().isEmpty());
    ...
    public void testConstrutorComParametros() {
        ...
        Utilizador utilizador = new Utilizador("email@example.com", "password", "Nome", "Morada", 123456789, compras, porVender, vendas, faturacao);

        assertEquals(2, utilizador.getId()); // Pressupondo que é o segundo utilizador a ser criado
    ...
    public void testEquals() {
        ...
        Utilizador utilizador1 = new Utilizador("email@example.com", "password", "Nome", "Morada", 123456789, compras, porVender, vendas, faturacao);
        Utilizador utilizador2 = new Utilizador("email@example.com", "password", "Nome", "Morada", 123456789, compras, porVender, vendas, faturacao);
        Utilizador utilizador3 = new Utilizador("diferente@example.com", "password", "Nome", "Morada", 123456789, compras, porVender, vendas, faturacao);
    ...
    public void testAdicionaRemoveFaturacao() {
        ...
        assertEquals(100.0, utilizador.getFaturacao().get(data));

        utilizador.removeFaturacao(data, 50.0);
        assertEquals(50.0, utilizador.getFaturacao().get(data));

        utilizador.removeFaturacao(data, 50.0);
        assertEquals(0.0, utilizador.getFaturacao().get(data));
    }
    ...
    public void testCalculaFaturacaoSempre() {
        ...
        assertEquals(300.0, utilizador.calculaFaturacaoSempre());
    }
    ...
    public void testCalculaFaturacaoIntervalo() {
        ...
        assertEquals(300.0, utilizador.calculaFaturacaoIntervalo(inicio, fim));
    }
}
