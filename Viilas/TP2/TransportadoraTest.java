...
public class TransportadoraTest {
    ...
    public void testConstrutorParametrizado() {
        ...
        assertEquals(10.0, transportadora.getValor_pequenas());
        assertEquals(20.0, transportadora.getValor_medio());
        assertEquals(30.0, transportadora.getValor_grande());
        assertEquals(0.2, transportadora.getImpostos());
        assertEquals(0.1, transportadora.getMargemlucro());
        assertEquals(0, transportadora.getTotalLucro());
